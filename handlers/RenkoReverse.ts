...
export default class RenkoReverse extends Base {
    constructor() {
        super(...arguments);
    ...
    doExecute() {
        ...
        const brickSizeLong = this.isPrevShort && isLong ? this.prevRange * this.reverse : this.brickSizeLong;
        const brickSizeShort = this.isPrevLong && isShort ? this.prevRange * this.reverse : this.brickSizeShort;
